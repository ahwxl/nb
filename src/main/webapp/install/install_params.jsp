...
<input type="hidden" name="dbFileName"
	value="/install/db/jspgou-db-4.sql" /> <input type="hidden"
	name="initFileName" value="/install/db/jspgou-init-4.sql" />
</form>
</body>
</html>
